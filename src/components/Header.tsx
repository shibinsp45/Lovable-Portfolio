  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? "bg-background/60 backdrop-blur-xl border-b border-border/30" : ""
      }`}
    >
          ...
          <div className="hidden md:flex items-center gap-1 px-4 py-2 rounded-full border border-border/40 bg-card/30 backdrop-blur-xl">
            {navLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="text-sm px-4 py-2 text-muted-foreground hover:text-foreground hover:bg-secondary/50 rounded-full transition-all duration-200"
              >
                {link.name}
              </a>
            ))}
            <a
              ...
              className="flex items-center gap-1 text-sm px-4 py-2 text-foreground hover:text-primary hover:bg-secondary/50 rounded-full transition-all duration-200"
            >
