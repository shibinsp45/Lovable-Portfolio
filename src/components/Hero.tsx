...
const Hero = () => {
  ...
  return <section ref={ref} className="min-h-screen flex flex-col justify-center pt-20 relative overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Stars layer */}
        {stars.map(star => <motion.div key={star.id} className="absolute rounded-full bg-foreground" style={{
        left: `${star.x}%`,
        top: `${star.y}%`,
        width: star.size,
        height: star.size
        ...
        {/* Shooting stars */}
        {shootingStars.map(star => <motion.div key={`shooting-${star.id}`} className="absolute w-[2px] h-[2px] bg-foreground rounded-full" style={{
        left: `${star.startX}%`,
        top: `${star.startY}%`,
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[85%]">
          <div className="w-[200vw] h-[200vw] rounded-full bg-[hsl(240,15%,4%)]" style={{
          boxShadow: `
        ...
        <motion.div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[hsl(var(--primary))] rounded-full blur-[250px] opacity-10" animate={{
        scale: [1, 1.15, 1],
        ...
        <motion.div className="absolute top-20 left-1/4 w-[400px] h-[400px] bg-[hsl(280,50%,40%)] rounded-full blur-[200px] opacity-8" animate={{
        scale: [1, 1.2, 1],
      ...
      scale
        ...
        ease: [0.25, 0.46, 0.45, 0.94]
          ...
          <motion.h1 className="text-5xl md:text-7xl lg:text-8xl font-quicksand font-light italic tracking-tight text-foreground" initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} animate={{
          ...
          <motion.h2 className="text-4xl md:text-6xl lg:text-7xl font-quicksand font-light italic tracking-tight text-foreground" initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} animate={{
          ...
          <motion.p className="text-3xl md:text-5xl lg:text-6xl font-quicksand font-light italic tracking-tight text-foreground" initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} animate={{
        ...
        stiffness: 100
          ...
          <Button variant="outline" size="lg" className="rounded-full px-8 py-6 text-lg border-border hover:bg-secondary hover:scale-105 transition-all duration-300">
