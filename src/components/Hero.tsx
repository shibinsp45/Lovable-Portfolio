  ...
  return <section ref={ref} className="min-h-screen flex flex-col justify-center pt-20 relative overflow-hidden bg-background">
      ...
      scale
        ...
        ease: [0.25, 0.46, 0.45, 0.94]
          ...
          <motion.h1 className="text-5xl md:text-7xl lg:text-8xl font-sans font-normal tracking-tight text-[hsl(220,70%,45%)]" initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} animate={{
          ...
          <motion.h2 className="text-4xl md:text-6xl lg:text-7xl font-sans font-normal tracking-tight text-[hsl(220,70%,45%)]" initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} animate={{
          ...
          delay: 0.6
            ...
            Craft by mind Design<br />with soul
          </motion.p>
        </motion.div>
