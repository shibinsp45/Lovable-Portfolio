...
const Career = () => {
  ...
  return <section className="py-24 bg-background overflow-hidden" ref={containerRef}>
      <div className="container mx-auto px-6">
        ...
        ease: [0.25, 0.46, 0.45, 0.94]
          ...
          <motion.h2 className="text-3xl md:text-5xl font-light text-muted-foreground" style={{ fontFamily: "'Quicksand', sans-serif" }} initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} whileInView={{
        ...
        <div className="space-y-12 relative">
          ...
          <div className="absolute left-0 md:left-[1px] top-0 bottom-0 w-[2px] bg-border hidden md:block">
            <motion.div style={{
            height: lineHeight
          ...
          delay: index * 0.15,
          ease: [0.25, 0.46, 0.45, 0.94]
        }} className="grid md:grid-cols-2 gap-6 md:gap-12 group">
              <div className="flex items-start gap-4">
                <motion.div className="hidden md:block w-3 h-3 rounded-full bg-primary mt-2 flex-shrink-0 relative z-10" initial={{
              scale: 0
            }} whileInView={{
              scale: 1
            }} viewport={{
              ...
              delay: index * 0.2
                  ...
                  <motion.span className="text-muted-foreground text-sm inline-block" whileHover={{
                x: 5
              }} transition={{
                duration: 0.2
              }}>
