        ...
        <div className="space-y-16 relative">
          ...
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className="grid md:grid-cols-2 gap-4 md:gap-12 group md:pl-8 bg-card/30 backdrop-blur-xl rounded-2xl p-6 border border-border/20 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300"
            >
