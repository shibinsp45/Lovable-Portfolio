    ...
    <section className="py-24 bg-background overflow-hidden" ref={containerRef}>
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <motion.h2 
            className="text-3xl md:text-5xl font-serif text-muted-foreground"
          ...
          {experiences.map((exp, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <motion.div 
                  className="hidden md:block w-3 h-3 rounded-full bg-primary mt-2 flex-shrink-0 relative z-10"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}
