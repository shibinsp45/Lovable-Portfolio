...
const WhyChooseMe = () => {
  ...
  return <section className="py-24 bg-background overflow-hidden relative" ref={containerRef}>
      ...
      <div className="container mx-auto px-6">
        ...
        ease: [0.25, 0.46, 0.45, 0.94]
          ...
          <motion.h2 className="text-3xl md:text-5xl font-light" style={{ fontFamily: "'Quicksand', sans-serif" }} initial={{
          opacity: 0,
          y: 30,
          filter: "blur(10px)"
        }} whileInView={{
        ...
        y
          ...
          transition: {
            duration: 0.3
              ...
              <motion.div className="w-12 h-12 rounded-xl bg-secondary flex items-center justify-center mb-6 group-hover:bg-primary/10 transition-colors duration-300" whileHover={{
            rotate: 10,
            scale: 1.1
          }} transition={{
            duration: 0.3
