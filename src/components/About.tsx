          ...
          ease: [0.25, 0.46, 0.45, 0.94]
            ...
            <div className="space-y-4">
              ...
              delay: 0.3
                ...
                <span className="bg-gradient-to-b from-muted-foreground/90 via-muted-foreground/60 to-muted-foreground/30 bg-clip-text text-transparent text-center">I am an Engineer turned</span>
                <br />
